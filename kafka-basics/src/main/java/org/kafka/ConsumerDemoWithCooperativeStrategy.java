...
public class ConsumerDemoWithCooperativeStrategy {
    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoWithCooperativeStrategy.class.getSimpleName());
